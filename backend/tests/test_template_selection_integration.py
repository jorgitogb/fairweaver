...
class TestTemplateSelectionIntegration:
    ...
    def test_template_selection_integration_genomics_detection(self):
        ...
        assert investigation_found, (
            "Genomics auto-template selection should have processed the content"
        )
    ...
    def test_template_selection_integration_sensor_detection(self):
        ...
        assert investigation_found, (
            "Sensor auto-template selection should have processed the content"
        )
    ...
    def test_template_selection_integration_with_field_paths(self):
        ...
        assert investigation_found, (
            "Template selection with field path integration should have processed the content"
        )
    ...
    def test_template_selection_integration_auto_with_no_clear_indicators(self):
        ...
        assert investigation_found, (
            "Auto-template selection with ambiguous content should fall back to default"
        )
    ...
    def test_template_selection_integration_consistency(self):
        ...
        for i in range(3):
            resp = client.post(
                "/convert/arc-export?preview=true",
                files={
                    "file": (f"consistency_test_{i}.json", content.encode(), "application/json")
                },
                data={"source_format": "auto", "pivot_id": "auto"},
            )
    ...
    def test_template_selection_integration_performance(self):
        ...
        assert elapsed_time < 5.0, (
            f"Template selection and conversion took too long: {elapsed_time}s"
        )
